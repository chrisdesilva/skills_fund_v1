  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        accessToken: `${process.env === "development"}  ? ${
          process.env.GATSBY_CONTENTFUL_DEV_ACCESS_TOKEN
        } : ${process.env.GATSBY_CONTENTFUL_PROD_ACCESS_TOKEN}`,
        host: `${process.env ===
          "development"}  ? 'preview.contentful.com' : 'cdn.contentful.com'`,
      },
    },
    {
